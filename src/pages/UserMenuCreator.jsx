  ...
  <div className="mt-6 p-4 max-w-xl mx-auto bg-yellow-50 border border-yellow-300 rounded-lg shadow-sm">
    ...
    <form
      onSubmit={(e) => {
        ...
        if (name) {
          window.open(`https://wa.me/919656015000?text=Hello%2C%20I%20want%20Petoba%20team%20to%20upload%20my%20menu%20for%20Rs249.%20Restaurant%20Name%3A%20${encodeURIComponent(name)}`, "_blank");
        } else {
...
<a
  href="https://wa.me/919656015000?text=Hello%2C%20I%20want%20help%20with%20Petoba%20menu%20upload."
  target="_blank"
  rel="noopener noreferrer"
